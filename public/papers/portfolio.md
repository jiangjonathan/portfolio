...
Realism is something I heavily prioritized and pursued in my design of the experience. This is why UI elements such as the player timeline can't be scrubbed with the mouse. I wanted all the interaction to be with the 3D model. I know vinyl records shouldn't have video, but when using the YouTube iframe for the player it would be a waste to hide it. Many songs have excellent music videos, and they could heighten the  experience, which is why I implemented a fullscreen mode for the player.
